...
/** Launch an app by id so its window can later be selected from `list_apps()`. On Windows, explicit `.exe` process paths/identifiers are also supported for apps that are not yet listed. */
